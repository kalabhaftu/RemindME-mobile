...
fun DashboardScreen(
    ...
    Column(
        ...
        com.example.remindme_mobile.ui.components.CalendarGrid(
        ...
        com.example.remindme_mobile.ui.components.UpcomingPanel(
            occurrences = uiState.occurrences,
...
fun QuickAddTile(modifier: Modifier = Modifier, label: String, icon: ImageVector, onTap: () -> Unit) {
    FloatingGlassContainer(
        ...
        Row(
            ...
            LiquidIcon(imageVector = icon, size = 20.dp, tint = TextPrimary)
